    ...
    return (
        <div name='projects' className='w-full md:h-screen text-gray-300 bg-[#0a192f]'>
            <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
                <div className='pb-8'>
                    <p className='text-4xl font-bold inline border-b-4 text-gray-300 border-pink-600 mt-8'>Projects</p>
                ...
                <div className='grid sm:grid-cols-2 md:grid-cols-3 gap-4'>
                    ...
                    {/* Grid Item 1 */}
                    <div
                        style={{ backgroundImage: `url(${naturalFarma})` }}
                        ...
                        <div className='opacity-0 group-hover:opacity-100'>
                            ...
                            <div className='pt-8 text-center'>
                                <a href="https://natural-farma.vercel.app/" target="_blank" rel="noopener noreferrer">
                                    <button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg'>Demo</button>
                                </a>
                                <a href="https://github.com/FabianCordobes/naturalFarma" target="_blank" rel="noopener noreferrer">
                    ...
                    <div
                        ...
                        <div className='opacity-0 group-hover:opacity-100'>
                            ...
                            <div className='pt-8 text-center'>
                                <a href="https://deploy-three-beryl.vercel.app/" target="_blank" rel="noopener noreferrer">
                                    <button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg'>Demo</button>
                                </a>
                                <a href="https://github.com/juanjustomuller/pokemon" target="_blank" rel="noopener noreferrer">
                                    <button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg'>Code</button>
                                </a>
                            </div>
                        </div>
